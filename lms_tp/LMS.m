...
[senal,FS]= audioread('voz_sola.wav'); 
[ruido,FS]= audioread('ruido_solo.wav');
[senal_ruido,FS]= audioread('conta.wav');
...
Ncoef= 512;          %orden del filtro adaptativo, cantidad de coeficientes
W = zeros (Ncoef,1);  % genera una matriz cuyos elementos son todos ceros
Mu= 0.002;            % set the step-size constant
...
%                         Guardar sonidos 
%--------------------------------------------------------------------------
%audiowrite((e),FS,'C:\Users\RafaG\Desktop\DSP (Yessica)\TP Final\0.01_nuevo');
audiowrite('C:\Users\RafaG\Desktop\DSP (Yessica)\TP Final\0.01_nuevo.wav', e, FS);
